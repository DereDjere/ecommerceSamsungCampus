...
export default class registerart extends Component {
    ...
    handleSubmit = e => {
        ...
        `);
            ...
            axios.post(`http://localhost:8000/api/artists`, array, {
                headers: {
            ...
            <Container className="centrer" fluid >
                <Form className="forme">
                    <Form.Label className="text-center">
                        <h4>CREATE AN ACCOUNT AS AN ARTIST</h4>
                    </Form.Label>
                </Form>
                <br />
                ...
                <Form className="form" onSubmit={this.handleSubmit}>
                    ...
                    <Form.Group controlId="formBasicCheckbox">
                        <Form.Check type="checkbox" label="By clicking on 'SIGN UP', you accept our general conditions of use and our privacy policy. This site is protected by reCAPTCHA, the use of which is subject to Google’s confidentiality rules and terms of use." />
                    </Form.Group>
                    <br />

...
export default class profileupdate extends Component {
    ...
    handleChange = e => {
        ...
        switch (name) {
            case 'firstname':
                formErrors.firstname = value.length < 5 || value.length > 20 ? '5-20 Characters for firstname please'
                    : "";
                break;
            default:
                break;
        ...
        return (
            <Container className="centrer" fluid >
                ...
                <Form className="forme">
                    <Form.Label className="text-center"><h4>Edit Your firstname </h4></Form.Label>
                </Form>
                <br />
                ...
                <Form className="form" onSubmit={this.handleSubmit}>
                    ...
                    <Form.Group>
                        <Form.Control className="taille" type="text" name="firstname" placeholder="firstname" onChange={this.handleChange} />
                        {formErrors.firstname.length > 0 && (
                            <span class="text-danger">{formErrors.firstname}</span>
                        )}
                    </Form.Group>
                    ...
                    <Button block variant="danger"  href="javascript:history.go(-1)">
                        Go Back
                    </Button>
                            ...
                            <Row>
                                <Col xs="10">
                                    <div className="left">
                                        ...
                                        <br />
                                        <div>{this.state.firstname}Zakariya </div>
                                    </div>
                                </Col>
                                <Col xs="2">
                                    <div className="right">

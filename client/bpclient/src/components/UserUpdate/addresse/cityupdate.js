        ...
        return (
            <Container className="centrer" fluid >
                ...
                <Form className="forme">
                    <Form.Label className="text-center"><h4>Edit Your City </h4></Form.Label>
                </Form>
                <br />
                ...
                <Form className="form" onSubmit={this.handleSubmit}>
                    ...
                    <Form.Group>
                        <Form.Control className="taille" type="text" name="city" placeholder="city" onChange={this.handleChange} />
                            ...
                            <Row>
                                <Col xs="10">
                                    <div className="left">
                                        ...
                                        <br />
                                        <div>{this.state.city}Zakariya </div>
                                    </div>
                                </Col>
                                <Col xs="2">
                                    <div className="right">

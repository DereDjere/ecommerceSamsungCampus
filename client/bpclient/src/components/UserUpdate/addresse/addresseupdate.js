        ...
        return (
            <Container className="centrer" fluid >
                ...
                <Form className="forme">
                    <Form.Label className="text-center"><h4>Edit Your Address </h4></Form.Label>
                </Form>
                <br />
                ...
                <Form className="form" onSubmit={this.handleSubmit}>
                    ...
                    <Form.Group>
                        <Form.Control className="taille" type="text" name="address" placeholder="Address" onChange={this.handleChange} />
                            ...
                            <Row>
                                <Col xs="10">
                                    <div className="left">
                                        ...
                                        <br />
                                        <div>{this.state.address}Zakariya </div>
                                    </div>
                                </Col>
                                <Col xs="2">
                                    <div className="right">
